...
for i in $( cat ${dirs} ); do
    ...
    pc_align --num-iterations 4000 --threads 28 --max-displacement $maxd --highest-accuracy ${i}_map_ba-PC.tif ../${i}_pedr4align.csv -o dem_align/${i}_map_ba_align --datum D_MARS --save-inv-trans
    ...
    echo point2dem --threads 28 --t_srs \"${proj}\" -r mars --nodata -32767 -s 24 ${i}_map_ba_align-trans_reference.tif --orthoimage -n --errorimage ../${i}_map_ba-L.tif -o ${i}_map_ba_align_24 | sh
    
    # Run dem_geoid on the align'd 24 m/px DEM so that the elevation values are comparable to MOLA products
    echo dem_geoid --threads 28 ${i}_map_ba_align_24-DEM.tif -o ${i}_map_ba_align_24-DEM | sh
    ...
    echo point2dem --threads 28 --t_srs \"${proj}\" -r mars --nodata -32767 -s 6 ${i}_map_ba_align-trans_reference.tif --orthoimage ../${i}_map_ba-L.tif -o ${i}_map_ba_align_6 --no-dem | sh
